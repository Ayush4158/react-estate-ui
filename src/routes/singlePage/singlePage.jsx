...
function SinglePage() {
  ...
  if (Object.keys(post).length === 0) return <div>Loading...</div>;
        ...
        <div className="wrapper">
          ...
          <div className="listVertical">
            <div className="feature">
              ...
              <div className="featureText">
                <span>Utilities</span>
                <p>{post.postDetail?.utilities || "N/A"}</p>
              </div>
            </div>
            <div className="feature">
              <img src="/pet.png" alt="" />
          ...
          <div className="listHorizontal">
            <div className="feature">
              ...
              <div className="featureText">
                <span>School</span>
                <p>{post.postDetail?.school * 100}m away</p>
              </div>
            </div>
            <div className="feature">
              <img src="/bus.png" alt="" />
              <div className="featureText">
                <span>Bus Stop</span>
                <p>{post.postDetail?.bus * 100}m away</p>
              </div>
            </div>
            <div className="feature">
              ...
              <div className="featureText">
                ...
                <p>{post.postDetail?.restaurant * 100}m away</p>
              </div>
            </div>
          </div>
